...
final_main=b7a0be9fcf081700c33241c3e47fb56563237f71bebe85104f279b42d875d1c5
...
[ "$#" -eq 9 ] || {
	echo "expected nine wireless-next patches, found $#" >&2
	exit 1
}
...
echo "wireless_next=ca800a930276 patches=9 baseline=match mail_headers=coherent final=match whitespace=clean"

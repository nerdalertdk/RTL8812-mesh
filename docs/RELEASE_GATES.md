...
| Open group traffic | Complete sender capture and at least 99% bidirectional delivery with two stable RTL8812AU radios | Two RTL8812AU peers delivered 399/400 and 400/400 with complete sender capture; revised three-frame reachability churn passed 20/20; no USB event | Pass |
| SAE/AMPE | Both peers prove completed SAE and decrypted AMPE, then pass bidirectional unicast, multicast, HWMP, and checksummed payload | Two RTL8812AU peers proved peer-specific SAE acceptance and decrypted AMPE, passed 20/20 pings each way, both multicast directions, reciprocal HWMP, and bidirectional checksummed 32 MiB payload; no USB event | Pass |
| 2.4 GHz HT20 channels | Fresh peering, cold traffic, multicast reachability, and HWMP on every channel allowed by the selected test regulatory profile | Two RTL8812AU peers passed channels 1--13 under DK: bilateral peering, cold unicast, multicast, and reciprocal HWMP; no USB event | Pass |

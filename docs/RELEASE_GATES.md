...
| Open group traffic | Complete sender capture and at least 99% bidirectional delivery with two stable RTL8812AU radios | After 0.1.6 reload, two 400-frame probes on `1-1.1`/`1-1.4` delivered 391/400 then 394/400 root-to-peer, while reverse delivery was 400/400 and no transport event occurred. Earlier 0.1.5 `1-1.1`/`1-1.4` control passed 399/400 and 400/400 | **Failing 0.1.6 gate; cause un-attributed** |

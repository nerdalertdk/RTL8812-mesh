...
| Open group traffic | Complete sender capture and at least 99% bidirectional delivery with two stable RTL8812AU radios | 2.4 GHz loss follows `…08:c1` across the `1-1.4`/`1-1.1` port swap (391/400 and 394/400 before; 333/400 after). The same adapter pair, USB branches, and workload deliver 400/400 in both directions on 5 GHz channel 149 with zero transport event | **2.4 GHz RF-path/antenna/environment fault; generic driver and tested USB paths not indicated** |
